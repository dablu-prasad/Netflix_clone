...
Sign In
      ...
      <div className="flex flex-col items-center justify-center text-center py-40 text-white py-40 text-white max-w-6xl mx-auto">
...
<h2 className="text-4xl md:text-5xl font-extrabold mb-4 text-balance">
    Downlaod your shows to watch offline
</h2>
<p className="text-lg md:text-xl">
...
{/* 3rd section */}
<div className="py-10 bg-black text-white">
<div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-row flex-col px-4 md:px-2">
{/* left side */}
<div className="flex-1 text-center md:text-left">
<h2 className="text-4xl md:text-5xl font-extrabold mb-4">Watch everywhere</h2>
<p className="text-lg md:text-xl">
    Stream unlimited movie and TV shows on your phone,tablets, laptop, and TV.
</p>
</div>
{/* right side */}
